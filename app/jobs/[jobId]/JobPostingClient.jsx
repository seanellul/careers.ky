      ...
      {grouped.map((el, i) => {
        if (el.type === "heading") {
          return (
            <h3
              key={i}
              className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mt-6 first:mt-0"
            >
              {el.text}
            </h3>
          );
...
export default function JobPostingClient({
  job,
  worcUrl,
  workTypes: wtObj,
  eduTypes: etObj,
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-6">
          <Button
            ...
            className="gap-2"
            onClick={() =>
              window.history.length > 1 ? window.history.back() : (window.location.href = "/jobs")
            }
          >
                  ...
                  {session?.candidateId &&
                    ...
                    interestState !== "sent" && (
                      ...
                      >
                        ...
                        {interestState === "sending" ? "Sending..." : "Express Interest"}
                      </Button>
                    )}
                  {interestState === "sent" && (
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">
                        {job.salaryLong || job.salaryShort || "Not specified"}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">
                        {locTypes.get(job.sLocation) || "Cayman Islands"}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">
                        {workTypes.get(job.sWork) || "Full-time"}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">
                        {eduTypes.get(job.sEducation) || "Not specified"}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">
                        {expTypes.get(job.sExperience) || "Not specified"}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {requirements.map((req, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-neutral-800 shadow-sm border border-neutral-200 dark:border-neutral-700"
                      >
              ...
              <CardContent className="p-4 sm:p-6 space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {job.kydPerAnnum > 0 && (
                    <div className="flex items-center justify-between">
                      <span className="text-neutral-500 flex items-center gap-2">
                        <DollarSign className="w-4 h-4" /> Annual (KYD)
                      </span>
                      <span className="font-medium">
                        CI$ {Math.round(job.kydPerAnnum).toLocaleString()}
                      </span>
                    </div>
                  )}
                  {job.Occupation && (
