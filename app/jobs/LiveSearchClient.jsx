            ...
            <Card key={`${j.jobPostId || idx}`} className="job-card group bg-white/5 border-white/10 hover:border-white/20 transition h-full">
              <CardContent className="p-5 h-full flex flex-col">
                ...
                <div className="mt-auto space-y-2">
                  <Link href={`/jobs/${j.jobPostIdString || j.jobPostId}`} className="inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-medium bg-cyan-500/20 text-cyan-300 border border-cyan-300/30 hover:bg-cyan-500/30 w-full gap-2 h-10 px-4 py-2 transition">
                    View Details
                  </Link>
