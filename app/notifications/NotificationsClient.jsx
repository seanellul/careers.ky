      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 py-8">
        ...
        <div className="space-y-3">
          {notifications.map((n) => (
            <Card
              key={n.id}
              className={`border transition ${n.is_read ? "bg-white dark:bg-neutral-800 shadow-sm border-neutral-200 dark:border-neutral-700" : "bg-primary-50 dark:bg-primary-500/15 border-primary-200 dark:border-primary-500/30"}`}
            >
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  {!n.is_read && (
                    <button
                      ...
                      className="p-1 rounded hover:bg-neutral-100 dark:bg-neutral-800 dark:hover:bg-neutral-800 transition"
                      title="Mark as read"
                    >
            ...
            <Card className="bg-white dark:bg-neutral-800 shadow-sm border-neutral-200 dark:border-neutral-700">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-neutral-500">
                  You'll be notified when new jobs match your profile or employers want to connect.
                </p>
              </CardContent>
            </Card>
          )}
