            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              <div className="lg:col-span-7 space-y-6 md:space-y-8">
                ...
                <h1 className="text-4xl/tight sm:text-5xl/tight md:text-6xl/tight font-semibold tracking-tight">
                  <span className="text-primary-500">A Caymanian-First</span> Careers{" "}
                  <span className="text-neutral-900 dark:text-neutral-100">Platform.</span>
                </h1>
                ...
                <div className="space-y-2 text-neutral-600 dark:text-neutral-400 text-base md:text-lg max-w-2xl">
                  <p>
                    <span className="text-primary-500 font-medium">For candidates:</span> Every
                    Caymanian deserves a fair shot at every role. Create your profile free. Get
                    matched. Get hired.
                  </p>
                  <p>
                    <span className="text-emerald-600 font-medium">For employers:</span> Find
                    Caymanian talent directly. Direct connections with your community. Save money.
                    One platform. One monthly fee.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Link href="/careers">
                    <Button size="lg" variant="secondary" className="gap-2 h-12 text-base w-full">
              ...
              <div className="lg:col-span-5">
                <div className="rounded-3xl p-1.5 bg-gradient-to-b from-primary-200 via-primary-50 to-transparent dark:from-primary-500/20 dark:via-primary-500/5 dark:to-transparent">
                  <div className="rounded-2xl bg-white/80 dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-700 p-4 md:p-6">
                    <div className="text-sm text-neutral-500 mb-4">Market Snapshot</div>
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <p className="text-xs text-neutral-500">Browse & filter active postings</p>
                      </Link>
                    ...
                    <CardContent className="p-5">
                      ...
                      <div className="space-y-2 pt-3 border-t border-neutral-200 dark:border-neutral-700">
                        <div className="flex items-center justify-between text-xs">
                          ...
                          <span className="font-semibold text-emerald-600">{track.jobCount}</span>
                        </div>
                        {track.avgSalary > 0 && (
                          <div className="flex items-center justify-between text-xs">
        ...
        <section className="py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div
                ref={addRevealEl}
                className="rounded-2xl bg-white dark:bg-neutral-800 border border-neutral-200/80 dark:border-neutral-700 shadow-sm p-8"
              >
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-6">
                  You shouldn&apos;t need connections to get a fair shot. Create a profile free. Get
                  seen by {employerCount > 0 ? employerCount.toLocaleString() + "+" : ""} employers
                  on the island. Get introduced directly — no recruiter middleman.
                </p>
                <div className="space-y-3 mb-6">
                  <div className="flex items-start gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    <span>
                      ...
                      Create your profile, get matched, get introduced. No cost to you.
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    <CheckCircle2 className="w-4 h-4 text-primary-500 mt-0.5 flex-shrink-0" />
                    <span>
                      ...
                      Not just the ones using one recruiter. Everyone.
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    <CheckCircle2 className="w-4 h-4 text-primary-500 mt-0.5 flex-shrink-0" />
                    <span>
                      ...
                      Employers contact you directly. Build real relationships.
                    </span>
                  </div>
                </div>
                <Button className="gap-2" onClick={() => setAuthModalOpen(true)}>
                  <User className="w-4 h-4" /> Create Your Free Profile{" "}
              ...
              >
                ...
                <p className="text-neutral-600 dark:text-neutral-400 mb-6">
                  Stop paying 15-25% per hire. Search Caymanian talent directly. Send introductions.
                  Build relationships. Hire faster. Stay compliant. One monthly fee.
                </p>
                <div className="space-y-3 mb-6">
                  <div className="flex items-start gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    <span>
                      ...
                      $299/month replaces 15-25% per-hire fees. Hiring 10 people/year? Save
                      CI$90-150K.
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    <span>
                      ...
                      Search talent by skill, education, experience, location. Direct introductions.
                      No recruiter delays.
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    <span>
                      ...
                      Timestamped records. Structured feedback. One-click reports. Proof you tried.
                    </span>
                  </div>
                </div>
                <Link href="/talent">
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              <div className="space-y-6">
                ...
                <p className="text-neutral-600 dark:text-neutral-400 text-lg">
                  Search Caymanian talent directly. Send introductions. Hire faster. Build
                  relationships. One flat fee — no per-hire commissions.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    onClick={() => {
                      if (typeof window !== "undefined") {
                        import("posthog-js").then((ph) =>
                          ph.default.capture("employer_cta_clicked", {
                            source: "homepage_employer_section",
                          })
                        );
                      }
                    }}
                  >
                    <Button
                      size="lg"
                      className="gap-2 h-12 text-base bg-emerald-600 hover:bg-emerald-700 text-white border-0"
                    >
                      <Users className="w-4 h-4" />
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/25">
                      ...
                      <div className="text-lg font-semibold text-red-600">
                        CI$10–16K<span className="text-xs font-normal">/hire</span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/25">
                      <div>
                        ...
                        <div className="text-xs text-emerald-600/70 dark:text-emerald-400/70">
                          Unlimited hires, one flat fee
                        </div>
                      </div>
                      <div className="text-lg font-semibold text-emerald-600">
                        CI$299<span className="text-xs font-normal">/mo</span>
                      </div>
                    </div>
                  </div>
                  <div className="text-center text-xs text-neutral-500 pt-2 border-t border-neutral-200 dark:border-neutral-700">
                    10 hires/year ={" "}
                    <span className="font-semibold text-emerald-600">CI$90–150K saved</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <Card className="bg-gradient-to-br from-primary-50 via-emerald-50 to-purple-50 dark:from-neutral-900 dark:via-neutral-900 dark:to-neutral-800 border-neutral-300 dark:border-neutral-700 backdrop-blur-md shadow-2xl">
              <CardContent className="p-8 md:p-12 text-center">
                <h3 className="text-2xl md:text-3xl font-semibold tracking-tight mb-4">
                  Ready to explore <span className="text-primary-500">{jobCount}+ active jobs</span>
                  ?
                </h3>
                <p className="text-neutral-600 dark:text-neutral-400 text-lg mb-8 max-w-2xl mx-auto">
                  Browse real-time job postings, filter by location, salary, and industry. Find your
                  next opportunity in Cayman.
                </p>
            ...
            >
              <AccordionItem value="item-1">
                ...
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  careers.ky is a Caymanian-First Careers Platform that makes hiring talent visible,
                  accessible and fair. For candidates, it&apos;s a free way to create a profile, get
                  matched to roles, and get introduced directly to employers. For employers, it
                  replaces recruiters — search Caymanian talent directly, send introductions, and
                  stay compliant. One monthly fee instead of 15-25% per hire.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger className="px-6">Is it free for candidates?</AccordionTrigger>
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  Yes, completely free. Create your profile, get matched to roles, get introduced to
                  employers — all at no cost. We make money from employer subscriptions, not from
                  candidates. You&apos;ll never pay a fee.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  ...
                  When you opt in to be discoverable, employers can find you through talent search
                  and request an introduction — but your name and contact details stay hidden until
                  you choose to accept. It&apos;s a double opt-in system designed to protect your
                  privacy while connecting you with relevant opportunities.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-4">
                <AccordionTrigger className="px-6">How do introductions work?</AccordionTrigger>
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  When an employer finds a candidate who matches their needs, they send an
                  introduction request. The candidate sees the employer and role details, then
                  chooses to accept or decline. If accepted, both parties can communicate directly.
                  No recruiter middleman. No commission. Just a direct connection.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  careers.ky Pro is $299/month — that replaces recruiter fees of 15-25% per hire
                  (CI$10-16K per person). A firm hiring 10 people a year saves CI$90-150K.
                  Enterprise is $799/month with unlimited reports, API access, and advanced
                  analytics.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-6">
                ...
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  Job postings are synced daily from WORC (my.egov.ky), the official government
                  portal for job opportunities in the Cayman Islands. You&apos;re seeing current,
                  active postings from official government sources.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-7">
                <AccordionTrigger className="px-6">
                  How does careers.ky help with compliance?
                </AccordionTrigger>
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  Every interaction on the platform creates a timestamped record. When employers
                  search talent, send introductions, and provide feedback, it&apos;s all documented
                  automatically. One-click compliance reports give employers proof they genuinely
                  considered Caymanian candidates — and candidates know they were fairly evaluated.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-8">
                <AccordionTrigger className="px-6">Who can use this platform?</AccordionTrigger>
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  careers.ky is built for Caymanians first — young professionals, career changers,
                  people re-entering the workforce. Employers of all sizes use it to find local
                  talent. We serve law firms, hospitality, financial services, government,
                  construction, retail — anyone hiring in Cayman.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-9">
                ...
                <AccordionContent className="px-6 text-neutral-600 dark:text-neutral-400">
                  Recruiters charge 15-25% of first-year salary per hire and control the
                  relationship between employer and candidate. careers.ky gives employers direct
                  access to Caymanian talent for a flat monthly fee. You search, you introduce, you
                  hire — directly. No per-hire fees. No middleman. Plus you get compliance
                  automation built in.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="text-xl font-semibold">
                      Your talent. Your opportunity. Fair shot.
                    </div>
                    <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                      Create your profile free and let every employer on the island find you. No
                      recruiter. No commission. Just opportunity.
                    </p>
                  ...
                  <div className="space-y-3 border-t pt-4 md:border-t-0 md:pt-0 md:border-l md:border-neutral-200 dark:border-neutral-700 md:pl-6">
                    ...
                    <div className="text-xl font-semibold">
                      Find Caymanian talent. Direct connections with your community.
                    </div>
                    <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                      Search local talent directly. Send introductions. One monthly fee replaces
                      15-25% per-hire recruiter costs.
                    </p>
                    <Link href="/talent">
