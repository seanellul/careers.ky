    ...
    <div>
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl font-semibold tracking-tight mb-2">
          <span className="text-cyan-300">Job Interests</span>
        </h1>
      ...
      {jobInterests.length === 0 ? (
        <Card className="bg-white/5 border-white/10">
          <CardContent className="p-12 text-center">
            <HeartHandshake className="w-12 h-12 mx-auto mb-4 opacity-50 text-neutral-400" />
            <h3 className="text-lg font-medium mb-2">No job interests yet</h3>
            <p className="text-neutral-400 mb-4">When you express interest in jobs, they&apos;ll appear here.</p>
            <Link href="/careers" className="text-cyan-300 hover:underline">
              Browse Jobs
            </Link>
          </CardContent>
        </Card>
        ...
        <div className="space-y-3">
          {jobInterests.map((ji) => (
            <Card key={ji.id} className="bg-white/5 border-white/10">
              <CardContent className="p-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {ji.message && (
                      <p className="text-sm text-neutral-300 mt-2 p-2 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <div className="flex items-center gap-3 mt-3 text-xs text-neutral-500">
                      ...
                      {ji.job_id && (
                        <Link href={`/jobs/${ji.job_id}`} className="text-cyan-300 hover:underline flex items-center gap-1">
