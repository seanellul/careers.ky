            ...
            <tbody>
              {sorted.map((emp) => (
                <tr key={emp.id} className="border-b border-white/5 hover:bg-white/[0.02]">
                  ...
                  <td className="px-4 py-3 text-neutral-300">{Number(emp.job_count)}</td>
                  <td className="px-4 py-3 text-neutral-300">{Number(emp.active_jobs)}</td>
                  <td className="px-4 py-3 text-neutral-400 text-xs">{emp.industry || "—"}</td>
                  <td className="px-4 py-3">
                    <span className="text-neutral-300">{Number(emp.view_count)}</span>
                    {emp.last_viewed && (
