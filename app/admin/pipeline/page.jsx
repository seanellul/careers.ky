  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
          ...
          <div className="lg:col-span-2">
            <label className="block text-xs font-medium text-neutral-600 dark:text-neutral-300 mb-2">
              Search by name
            </label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded text-neutral-900 dark:text-white placeholder-neutral-500 focus:outline-none focus:border-primary-500"
              />
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg overflow-hidden">
          ...
          <table className="w-full text-sm">
            <thead className="bg-neutral-50 dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700">
              <tr>
                ...
                <th className="px-4 py-3 text-center font-semibold text-neutral-600 dark:text-neutral-300 whitespace-nowrap">
                  <button
                    onClick={() => {
                      setSortBy("score");
                      setSortOrder(
              ...
              {loading ? (
                <tr>
                  <td colSpan="6" className="px-4 py-8 text-center">
                    <Loader size={20} className="mx-auto animate-spin text-neutral-500" />
                  </td>
                </tr>
              ) : records.length === 0 ? (
                <tr>
                  ...
                  <tr key={record.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors">
                    <td className="px-4 py-3">
                      <Link
                        ...
                        className="text-neutral-900 dark:text-white hover:text-primary-500 transition-colors font-medium"
                      >
        ...
        {/* Pagination */}
        {pagination?.total > 0 && (
          <div className="px-4 py-3 border-t border-neutral-200 dark:border-neutral-700 flex items-center justify-between bg-neutral-50 dark:bg-neutral-800">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={offset === 0}
                className="px-3 py-1 bg-neutral-200 dark:bg-neutral-700 hover:bg-neutral-300 dark:hover:bg-neutral-600 disabled:opacity-50 disabled:cursor-not-allowed rounded text-neutral-900 dark:text-white transition-colors"
              >
                Previous
              </button>
              <button
