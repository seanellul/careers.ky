...
// ── Page shells ──────────────────────────────────────────────
export const page =
  "min-h-screen bg-[#FEFCF3] dark:bg-[#171412] text-neutral-800 dark:text-neutral-100";
export const pageGradient = "fixed inset-0 -z-10 bg-[length:200%_200%]";
...
export const cardSelected =
  "bg-white dark:bg-neutral-900 border-2 border-primary-500 rounded-2xl shadow-sm";
export const cardSelectedAccent =
  "bg-white dark:bg-neutral-900 border-2 border-accent-500 rounded-2xl shadow-sm";

// ── Glass (for overlaying on gradients) ──────────────────────
export const glass =
  "bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm border border-neutral-200 dark:border-neutral-800 rounded-2xl";
...
export const badgeAccent =
  "bg-primary-50 dark:bg-primary-500/15 border border-primary-200 dark:border-primary-500/30 text-primary-700 dark:text-primary-300";
export const badgeWarm =
...
export const tableHeader =
  "bg-neutral-50 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 text-xs font-medium uppercase tracking-wider";
...
export const statusWarning =
  "text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-500/15 border-amber-200 dark:border-amber-500/30";
export const statusError =
  "text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-500/15 border-red-200 dark:border-red-500/30";
export const statusInfo =
  "text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-500/15 border-primary-200 dark:border-primary-500/30";
