...
export const getCachedCisco = unstable_cache(() => loadCISCO(), ["cisco-units"], {
  revalidate: WEEK,
  tags: ["taxonomy"],
});
...
export const getCachedActiveJobs = unstable_cache(() => getActiveJobPostings(), ["active-jobs"], {
  revalidate: DAY,
  tags: ["jobs"],
});

export const getCachedEmployerList = unstable_cache(() => getEmployerList(), ["employer-list"], {
  revalidate: DAY,
  tags: ["employers", "jobs"],
});
...
export const getCachedExperienceTypes = cachedLookupAsEntries(
  loadExperienceTypes,
  "experience-types"
);
