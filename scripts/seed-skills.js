...
const SKILL_PATTERNS = [
  // Finance & Compliance
  {
    pattern: /\b(financial analysis|financial reporting|financial modelling)\b/gi,
    name: "Financial Analysis",
    category: "Finance",
  },
  {
    pattern: /\b(aml|anti-money laundering)\b/gi,
    name: "AML/Anti-Money Laundering",
    category: "Compliance",
  },
  { pattern: /\b(kyc|know your customer)\b/gi, name: "KYC", category: "Compliance" },
  {
    pattern: /\b(compliance|regulatory compliance)\b/gi,
  ...
  {
    pattern: /\b(risk management|risk assessment)\b/gi,
    name: "Risk Management",
    category: "Finance",
  },
  {
    pattern: /\b(investment|portfolio management)\b/gi,
    name: "Investment Management",
    category: "Finance",
  },
  {
    pattern: /\b(fund administration|fund accounting)\b/gi,
  ...
  {
    pattern: /\b(contracts|contract management)\b/gi,
    name: "Contract Management",
    category: "Legal",
  },
  {
    pattern: /\b(intellectual property|patents)\b/gi,
  ...
  // Technology
  {
    pattern: /\b(software development|programming|coding)\b/gi,
    name: "Software Development",
    category: "Technology",
  },
  {
    pattern: /\b(web development|web design)\b/gi,
    name: "Web Development",
    category: "Technology",
  },
  {
    pattern: /\b(database|sql|data management)\b/gi,
    name: "Database Management",
    category: "Technology",
  },
  {
    pattern: /\b(network|networking|network administration)\b/gi,
    name: "Network Administration",
    category: "Technology",
  },
  {
    pattern: /\b(cybersecurity|information security|it security)\b/gi,
    name: "Cybersecurity",
    category: "Technology",
  },
  {
    pattern: /\b(cloud computing|cloud services)\b/gi,
    name: "Cloud Computing",
    category: "Technology",
  },
  {
    pattern: /\b(data analysis|data analytics|data science)\b/gi,
    name: "Data Analytics",
    category: "Technology",
  },
  {
    pattern: /\b(artificial intelligence|machine learning)\b/gi,
    name: "AI/Machine Learning",
    category: "Technology",
  },
  {
    pattern: /\b(system administration|systems admin)\b/gi,
    name: "Systems Administration",
    category: "Technology",
  },
  {
    pattern: /\b(it support|technical support|helpdesk)\b/gi,
    name: "IT Support",
    category: "Technology",
  },
  ...
  {
    pattern: /\b(people management|team management|leadership)\b/gi,
  ...
  {
    pattern: /\b(quality assurance|quality control)\b/gi,
    name: "Quality Assurance",
    category: "Management",
  },
  {
    pattern: /\b(supply chain|procurement|purchasing)\b/gi,
    name: "Supply Chain/Procurement",
    category: "Management",
  },
  {
    pattern: /\b(business development|business strategy)\b/gi,
  ...
  {
    pattern: /\b(social media|content creation)\b/gi,
    name: "Social Media/Content",
    category: "Marketing",
  },
  {
    pattern: /\b(public relations|communications)\b/gi,
  ...
  {
    pattern: /\b(graphic design|visual design)\b/gi,
    name: "Graphic Design",
    category: "Marketing",
  },
  ...
  {
    pattern: /\b(training|employee development)\b/gi,
  ...
  // Healthcare
  {
    pattern: /\b(patient care|healthcare|medical)\b/gi,
  ...
  // Hospitality & Tourism
  {
    pattern: /\b(hospitality|hotel management)\b/gi,
    name: "Hospitality Management",
    category: "Hospitality",
  },
  {
    pattern: /\b(food service|catering|culinary)\b/gi,
  ...
  {
    pattern: /\b(civil engineering|structural)\b/gi,
    name: "Civil Engineering",
    category: "Engineering",
  },
  {
    pattern: /\b(electrical|electronics)\b/gi,
    name: "Electrical Engineering",
    category: "Engineering",
  },
  {
    pattern: /\b(mechanical engineering|machinery)\b/gi,
  ...
  // Education
  {
    pattern: /\b(teaching|education|instruction)\b/gi,
    name: "Teaching/Education",
    category: "Education",
  },
  {
    pattern: /\b(curriculum|lesson planning)\b/gi,
  ...
  {
    pattern: /\b(presentation|public speaking)\b/gi,
...
async function seedSkills() {
  ...
  const ciscoUnits =
    await sql`SELECT cisco_code, title, description, tasks FROM cisco_units WHERE LENGTH(cisco_code) = 4`;
