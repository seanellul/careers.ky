...
export default function SignInForm({ initialLoginType = "candidate" }) {
  ...
  useLayoutEffect(() => {
    ...
    const btn =
      loginType === "candidate" ? segmentBtnCandidateRef.current : segmentBtnEmployerRef.current;
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-neutral-500 mt-1">Sign in to get started — it's free</p>
      </div>
      ...
      >
        ...
        >
          ...
          <span className="text-left leading-tight">
            ...
            <span className="block text-[10px] font-normal opacity-80 sm:text-[11px]">
              Candidates
            </span>
          </span>
        </button>
      ...
      <div className="flex flex-col gap-3">
        <a
          ...
          className="flex items-center justify-center gap-2 px-4 py-3 min-h-[48px] rounded-xl bg-neutral-900 dark:bg-neutral-800 text-white text-sm font-medium hover:bg-neutral-800 dark:hover:bg-neutral-700 border border-transparent dark:border-neutral-600 transition"
        >
