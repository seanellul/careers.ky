    ...
    return (
      <div className="max-w-xl mx-auto text-center py-12 px-4">
        ...
        <p className="text-neutral-500 text-sm mb-8">
          Check your inbox — we've sent a confirmation to <strong>{form.email}</strong> with details
          on what's included in Pro. We'll email you as soon as your access is ready.
        </p>
        <a
          href="/careers"
          className="inline-flex items-center gap-2 text-primary-500 hover:underline text-sm font-medium"
        >
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-6">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 text-lg">
            Search Caymanian talent directly. Send introductions. One flat monthly fee — no
            recruiters, no per-hire commissions.
          </p>
          ...
          <div className="space-y-3">
            {[
              {
                icon: Users,
                title: "Search talent directly",
                desc: "Filter by skills, CISCO code, experience, location & availability",
              },
              {
                icon: Shield,
                title: "Automated compliance records",
                desc: "Timestamped proof you considered Caymanian candidates",
              },
              {
                icon: TrendingUp,
                title: "CI$299/month flat fee",
                desc: "Hiring 10 people a year? Save CI$90–150K vs recruiters",
              },
          ...
          <div className="p-4 rounded-xl bg-primary-50 dark:bg-primary-500/10 border border-primary-200 dark:border-primary-500/25 text-sm text-primary-700 dark:text-primary-300">
            <strong>Early access:</strong> We're onboarding employers in batches. Join now to secure
            your spot.
          </div>
        </div>
        ...
        <Card className="bg-white dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 shadow-lg">
          <CardContent className="p-6 md:p-8">
            ...
            <p className="text-sm text-neutral-500 mb-6">
              Free to join. We'll email you when your access is ready.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 mb-1.5 block">
                  What are you primarily hiring for?{" "}
