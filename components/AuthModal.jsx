  ...
  return (
    ...
    >
      <div className={t.modal}>
        ...
        <p className="text-sm text-neutral-500 mb-6">Sign in to get started — it's free</p>

        <div className="flex flex-col gap-3">
          <a
            href={`/api/auth/google?type=${loginType}`}
            onClick={() =>
              posthog.capture("auth_method_chosen", { method: "google", auth_type: loginType })
            }
          ...
          <a
            ...
            onClick={() =>
              posthog.capture("auth_method_chosen", { method: "linkedin", auth_type: loginType })
            }
