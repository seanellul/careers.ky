  ...
  const navContent = (
    <nav className="flex flex-col gap-1">
      <div className="px-3 mb-4">
        <span className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Admin</span>
      </div>
      {items.map((item) => {
    ...
    <>
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 z-40">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-64 bg-white border-r border-neutral-200 p-4 overflow-y-auto">
