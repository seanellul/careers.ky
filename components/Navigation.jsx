              ...
              <div className="flex flex-col sm:flex-row items-stretch gap-2">
                <div className="flex-1">
                  ...
                  <select
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2 h-10 text-sm text-neutral-200"
                  >
                ...
                <div className="flex items-end gap-2">
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 min-h-[44px] rounded-lg bg-white text-neutral-900 text-sm font-medium hover:bg-neutral-100 transition"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-2 min-h-[44px] rounded-lg text-white text-sm font-medium hover:opacity-90 transition"
